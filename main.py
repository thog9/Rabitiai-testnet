...
╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═╝░░░╚═╝░░░╚═╝  ░░░╚═╝░░░╚══════╝╚═════╝░░░░╚═╝░░░╚═╝░░╚══╝╚══════╝░░░╚═╝░░░
    ...
    print_border("RABITIAI TESTNET", Fore.GREEN)
...
async def run_autoinvite(language: str):
    from scripts.autoinvite import run_autoinvite as autoinvite_run
    await autoinvite_run(language)

async def run_autocommunity(language: str):
    from scripts.autocommunity import run_autocommunity as autocommunity_run
    await autocommunity_run(language)

async def run_autoonchaintask(language: str):
    from scripts.autoonchaintask import run_autoonchaintask as autoonchaintask_run
    await autoonchaintask_run(language)
...
SCRIPT_MAP = {
    ...
    "autoinvite": run_autoinvite,
    "autocommunity": run_autocommunity,
    "autoonchaintask": run_autoonchaintask,
    "exit": cmd_exit
}
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            {"name": "1. Faucet pRIAI  │ RabitiAI Testnet", "value": "faucet", "locked": True},
            {"name": "2. Checkin hàng ngày  │ RabitiAI Testnet", "value": "checkin", "locked": True},
            {"name": "3. Tự động hoàn thành nhiệm vụ → Onchain Tasks  │ RabitiAI Testnet", "value": "autoonchaintask", "locked": True},
            {"name": "4. Tự động hoàn thành nhiệm vụ → Daily Tasks  │ RabitiAI Testnet", "value": "autotask", "locked": True},
            {"name": "5. Tự động hoàn thành nhiệm vụ mời bạn bè → Daily Tasks  │ RabitiAI Testnet", "value": "autoinvite", "locked": True},
            {"name": "6. Tự động hoàn thành nhiệm vụ  → Join RabitiAI's Community  │ RabitiAI Testnet", "value": "autocommunity", "locked": True},

            {"name": "X. Thoát", "value": "exit"},
        ],
        'en': [
            {"name": "1. Faucet pRIAI  │ RabitiAI Testnet", "value": "faucet", "locked": True},
            {"name": "2. Daily Checkin  │ RabitiAI Testnet", "value": "checkin", "locked": True},
            {"name": "3. Auto Tasks → Onchain Tasks  │ RabitiAI Testnet", "value": "autoonchaintask", "locked": True},
            {"name": "4. Auto Tasks → Daily Tasks  │ RabitiAI Testnet", "value": "autotask", "locked": True},
            {"name": "5. Auto Tasks Invite Friends → Daily Tasks  │ RabitiAI Testnet", "value": "autoinvite", "locked": True},
            {"name": "6. Auto Tasks Community  → Join RabitiAI's Community  │ RabitiAI Testnet", "value": "autocommunity", "locked": True},
